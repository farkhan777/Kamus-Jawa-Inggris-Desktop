...
public class EnglishAppHalusController implements Initializable {
    ...
    void kasar(MouseEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/sample/Views/EnglishAppKasar.fxml"));
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            ResultSet resultSet = connection.createStatement().executeQuery("select * from halus_eng_jawa");
